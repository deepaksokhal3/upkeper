        ...
        <tbody>
            <?php if (isset($visitors->reports[0]->data->rows)) { ?>
                <tr>
                    ...
                    <td><span class="td-title"><?= $visitors->reports[0]->data->totals[0]->values[1] ? round_figure($visitors->reports[0]->data->totals[0]->values[1])  . '%' : ''; ?></span>
