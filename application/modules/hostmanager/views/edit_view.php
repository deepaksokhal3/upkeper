                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="card panel">
                                        <div class="card-block">
                                            <?php echo form_open('21232f297a57a5a743894a0e4a801fc3/add-host-company', array('name' => 'company', 'class' => '', 'method' => 'post')); ?>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-xl-12">
                                                    ...
                                                    <input type="text"
                                                           ...
                                                           value="<?= (isset($host->host_company)) ? $host->host_company : ''; ?>"
                                            ...
                                            <div class="row">
                                                <div class="form-group col-xl-12">
                                                    ...
                                                    <input type="text"
                                                           ...
                                                           data-validation="length"
                                                           data-validation-length="3-50"
                                                           value="<?= (isset($host->host_company_url)) ? $host->host_company_url : ''; ?>"
                                            ...
                                            <div id="server_namess" class="row">
                                                <?php $i = 1; foreach (explode(",",$host->name_server) as  $key => $server) { ?>
